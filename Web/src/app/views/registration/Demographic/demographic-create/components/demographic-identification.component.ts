...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, NgxMaskDirective, TranslatePipe, FilledOnValueDirective],
  template: `
  <div class="row mb-4">
    <div class="col-12">
      <div class="card">
    ...
    <input type="text" class="form-control" appFilledOnValue
      ...
      formControlName="personSocialSecurityNo" placeholder="{{'ENTER_SSN' | translate }}" [mask]="'000-00-0000'" />
            ...
            <div class="col-md-3 col-sm-4 col-12">
              ...
              <input type="text" class="form-control" appFilledOnValue formControlName="LaborCardNo" placeholder="{{'ENTER_LABOR_CARD_NO' | translate}}" />
            </div>
            ...
            <div class="col-md-3 col-sm-4 col-12">
              ...
              <select class="form-select" appFilledOnValue formControlName="Religion">
            ...
            <div class="col-md-3 col-sm-4 col-12">
              ...
              <select class="form-select" appFilledOnValue formControlName="PersonEthnicityTypeId">
            ...
            <div class="col-md-3 col-sm-4 col-12">
              ...
              <input type="text" class="form-control" appFilledOnValue formControlName="PersonPassportNo" placeholder="{{'ENTER_PASSPORT_NO' | translate}}" />
            </div>

            <div class="col-md-3 col-sm-4 col-12">
              <label>{{'DRIVING_LICENSE_NO' | translate}}</label>
              <input type="text" class="form-control" appFilledOnValue formControlName="PersonDriversLicenseNo" placeholder="{{'ENTER_DRIVING_LICENSE_NO' | translate}}" [mask]="'SS000000'" />
            </div>

            <div class="col-md-3 col-sm-4 col-12">
              <label>{{'UNIFIED_NO' | translate}}</label>
              <input type="text" class="form-control" appFilledOnValue formControlName="ResidenceVisaNo" placeholder="{{'ENTER_UNIFIED_NO' | translate}}" [mask]="'000000000'" />
            </div>

            <div class="col-md-3 col-sm-4 col-12">
              <label>{{'LANGUAGE' | translate}}</label>
              <select class="form-select" appFilledOnValue formControlName="PrimaryLanguage">
            ...
            <div class="col-md-3 col-sm-4 col-12">
              ...
              <select class="form-select" appFilledOnValue formControlName="MediaChannelId">
            ...
            <div class="col-md-3 col-sm-4 col-12">
              ...
              <select class="form-select" appFilledOnValue formControlName="MediaItemId">
            ...
            <div class="col-md-3 col-sm-4 col-12">
              ...
              <input type="text" class="form-control" appFilledOnValue formControlName="causeofDeath" placeholder="{{'ENTER_CAUSE_OF_DEATH' | translate}}" />
            </div>

            <div class="col-md-3 col-sm-4 col-12">
              <label>{{'DOD' | translate }}</label>
              <input type="text" class="form-control date" appFilledOnValue data-provider="flatpickr" formControlName="DeathDate" id="deathDate" placeholder="{{'SELECT_DATE' | translate}}" />
            </div>
