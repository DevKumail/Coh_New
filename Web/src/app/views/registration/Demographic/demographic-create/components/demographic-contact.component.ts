  ...
  template: `
    <form [formGroup]="contactForm" class="row g-3">
      ...
      <div class="col-md-3">
        ...
        <input class="form-control" appFilledOnValue
      ...
      <div class="col-md-3">
        ...
        <input class="form-control" appFilledOnValue placeholder="{{'ENTER_DWELLING_NUMBER' | translate}}" formControlName="dwellingNumber" type="text" />
      </div>
      ...
      <div class="col-md-3">
        ...
        <input class="form-control" appFilledOnValue formControlName="faxNo" type="text" placeholder="{{'ENTER_FAX_NO' | translate}}" />
      </div>
      ...
      <div class="col-md-3">
        ...
        <div class="input-group">
          <input type="email" class="form-control" appFilledOnValue
