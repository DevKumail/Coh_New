    ...
    <form [formGroup]="assignmentForm" class="d-flex justify-content-md-evenly">
      ...
      <div class="card col-4 p-3">
        <div class="form-check mb-3">
          ...
          <label for="proofOfIncomeCheck" class="form-check-label ms-2">Proof Of Income</label>
        </div>

        <div class="mb-3">
          <input type="text" class="form-control" placeholder="Proof Of Income" formControlName="proofOfIncome" />
        </div>
