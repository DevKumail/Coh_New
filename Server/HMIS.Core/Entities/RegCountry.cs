...
public partial class RegCountry
{
    ...
    public virtual ICollection<RegPatientTemp> RegPatientTempNokcountries { get; set; } = new List<RegPatientTemp>();

    [InverseProperty("PersonCountry")]
    public virtual ICollection<RegPatientTemp> RegPatientTempPersonCountries { get; set; } = new List<RegPatientTemp>();
}
