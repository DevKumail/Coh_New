...
public partial class HMISDbContext : DbContext
{
    ...
    public virtual DbSet<EmrnoteTemplate> EmrnoteTemplate { get; set; }

    public virtual DbSet<EmrnoteVoiceinText> EmrnoteVoiceinText { get; set; }

    public virtual DbSet<EmrnotesAnswer> EmrnotesAnswer { get; set; }

    public virtual DbSet<EmrnotesEncounterPath> EmrnotesEncounterPath { get; set; }

    public virtual DbSet<EmrnotesNote> EmrnotesNote { get; set; }
    ...
    public virtual DbSet<IvfepisodeAspirationFurtherDetails> IvfepisodeAspirationFurtherDetails { get; set; }

    public virtual DbSet<IvfepisodeAspirationOocyteRetrieval> IvfepisodeAspirationOocyteRetrieval { get; set; }

    public virtual DbSet<IvfepisodeBirth> IvfepisodeBirth { get; set; }

    public virtual DbSet<IvfepisodeBirthChromosomeAnomaly> IvfepisodeBirthChromosomeAnomaly { get; set; }

    public virtual DbSet<IvfepisodeBirthCongenitalMalformation> IvfepisodeBirthCongenitalMalformation { get; set; }
    ...
    public virtual DbSet<IvflabOrderSet> IvflabOrderSet { get; set; }

    public virtual DbSet<Ivfmain> Ivfmain { get; set; }

    public virtual DbSet<IvfmaleCryoContracts> IvfmaleCryoContracts { get; set; }

    public virtual DbSet<IvfmaleCryoPreservation> IvfmaleCryoPreservation { get; set; }

    public virtual DbSet<IvfmaleCryoStraw> IvfmaleCryoStraw { get; set; }
    ...
    public virtual DbSet<IvfoverviewMedicationApplicationDomain> IvfoverviewMedicationApplicationDomain { get; set; }

    public virtual DbSet<IvfoverviewMedicationTime> IvfoverviewMedicationTime { get; set; }
    ...
    public virtual DbSet<IvfpregnancyComplicationAfter20th> IvfpregnancyComplicationAfter20th { get; set; }

    public virtual DbSet<IvfpregnancyComplicationUntil20th> IvfpregnancyComplicationUntil20th { get; set; }
    ...
    public virtual DbSet<IvftreatmentEpisodePregnancyStage> IvftreatmentEpisodePregnancyStage { get; set; }

    public virtual DbSet<IvftreatmentEpisodeTransferStage> IvftreatmentEpisodeTransferStage { get; set; }
    ...
    public virtual DbSet<IvftreatmentTypes> IvftreatmentTypes { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EmrnoteTemplate>(entity =>
        {
            entity.HasOne(d => d.Note).WithMany(p => p.EmrnoteTemplate)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EMRNoteTemplate_EMRNotesNote");

            entity.HasOne(d => d.Template).WithMany(p => p.EmrnoteTemplate)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EMRNoteTemplate_EMRNotesEncounterPath");
        });
        ...
        modelBuilder.Entity<EmrnotesNote>(entity =>
        {
        ...
        modelBuilder.Entity<IvfcryoContainers>(entity =>
        {
        ...
        modelBuilder.Entity<IvfcryoLevelA>(entity =>
        {
            ...
            entity.HasOne(d => d.Container).WithMany(p => p.IvfcryoLevelA)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Cryo_Leve__Conta__43E1002F");
        });

        modelBuilder.Entity<IvfcryoLevelB>(entity =>
        {
            ...
            entity.HasOne(d => d.LevelA).WithMany(p => p.IvfcryoLevelB)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Cryo_Leve__Level__48A5B54C");
        });

        modelBuilder.Entity<IvfcryoLevelC>(entity =>
        {
        ...
        modelBuilder.Entity<IvfdashboardTreatmentCycle>(entity =>
        {
            ...
            entity.HasOne(d => d.PlannedSpermCollectionCategory).WithMany(p => p.IvfdashboardTreatmentCyclePlannedSpermCollectionCategory).HasConstraintName("FK_IVFFemaleTreatmentCycle_DropdownConfiguration6");
            ...
            entity.HasOne(d => d.TreatmentTypeCategory).WithMany(p => p.IvfdashboardTreatmentCycleTreatmentTypeCategory).HasConstraintName("FK_IVFFemaleTreatmentCycle_DropdownConfiguration");
        });

        modelBuilder.Entity<IvfembblastIndications>(entity =>
        {
        ...
        modelBuilder.Entity<IvfepisodeAspirationFurtherDetails>(entity =>
        {
            entity.Property(e => e.FurtherDetailsId).ValueGeneratedNever();
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.Aspiration).WithOne(p => p.IvfepisodeAspirationFurtherDetails)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFEpisodeAspirationFurtherDetails_IVFTreatmentEpisodeAspirationStage");

            entity.HasOne(d => d.AspirationSystemCategory).WithMany(p => p.IvfepisodeAspirationFurtherDetailsAspirationSystemCategory).HasConstraintName("FK_IVFEpisodeAspirationFurtherDetails_DropdownConfiguration");

            entity.HasOne(d => d.GeneralConditionCategory).WithMany(p => p.IvfepisodeAspirationFurtherDetailsGeneralConditionCategory).HasConstraintName("FK_IVFEpisodeAspirationFurtherDetails_DropdownConfiguration1");

            entity.HasOne(d => d.MucousMembraneCategory).WithMany(p => p.IvfepisodeAspirationFurtherDetailsMucousMembraneCategory).HasConstraintName("FK_IVFEpisodeAspirationFurtherDetails_DropdownConfiguration2");
        });
        ...
        modelBuilder.Entity<IvfepisodeAspirationOocyteRetrieval>(entity =>
        {
            ...
            entity.HasOne(d => d.AnesthesiaCategory).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalAnesthesiaCategory).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_DropdownConfiguration1");

            entity.HasOne(d => d.Anesthetist).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalAnesthetist).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_HREmployee2");

            entity.HasOne(d => d.Embryologist).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalEmbryologist).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_HREmployee1");

            entity.HasOne(d => d.FurtherComplicationsCategory).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalFurtherComplicationsCategory).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_DropdownConfiguration3");

            entity.HasOne(d => d.FurtherMeasureCategory).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalFurtherMeasureCategory).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_DropdownConfiguration5");

            entity.HasOne(d => d.Nurse).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalNurse).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_HREmployee3");

            entity.HasOne(d => d.OperatingProvider).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalOperatingProvider).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_HREmployee");

            entity.HasOne(d => d.PrimaryComplicationsCategory).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalPrimaryComplicationsCategory).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_DropdownConfiguration2");

            entity.HasOne(d => d.PrimaryMeasureCategory).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalPrimaryMeasureCategory).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_DropdownConfiguration4");

            entity.HasOne(d => d.RetrievalTechniqueCategory).WithMany(p => p.IvfepisodeAspirationOocyteRetrievalRetrievalTechniqueCategory).HasConstraintName("FK_IVFEpisodeApirationOocyteRetrieval_DropdownConfiguration");
        });

        modelBuilder.Entity<IvfepisodeBirth>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.Birth).WithMany(p => p.IvfepisodeBirth)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFEpisodeBirth_IVFTreatmentEpisodeBirthStage");

            entity.HasOne(d => d.Country).WithMany(p => p.IvfepisodeBirth).HasConstraintName("FK_IVFEpisodeBirth_RegCountries");

            entity.HasOne(d => d.DeliveryMethodCategory).WithMany(p => p.IvfepisodeBirth).HasConstraintName("FK_IVFEpisodeBirth_DropdownConfiguration");

            entity.HasOne(d => d.Gender).WithMany(p => p.IvfepisodeBirth).HasConstraintName("FK_IVFEpisodeBirth_RegGender");
        });

        modelBuilder.Entity<IvfepisodeBirthChromosomeAnomaly>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.Birth).WithMany(p => p.IvfepisodeBirthChromosomeAnomaly)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<IvfepisodeBirthCongenitalMalformation>(entity =>
        {
            ...
            entity.HasOne(d => d.Birth).WithMany(p => p.IvfepisodeBirthCongenitalMalformation)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<IvfepisodePregnancy>(entity =>
        {
            ...
            entity.HasOne(d => d.FetalPathologyComplicationCategory).WithMany(p => p.IvfepisodePregnancy).HasConstraintName("FK_IVFEpisodePregnancy_DropdownConfiguration");
        ...
        modelBuilder.Entity<IvfepisodeTransfer>(entity =>
        {
            ...
            entity.HasOne(d => d.CatheterCategory).WithMany(p => p.IvfepisodeTransferCatheterCategory).HasConstraintName("FK_IVFEpisodeTransfer_DropdownConfiguration");

            entity.HasOne(d => d.Embryologist).WithMany(p => p.IvfepisodeTransferEmbryologist).HasConstraintName("FK_IVFEpisodeTransfer_HREmployee2");

            entity.HasOne(d => d.FurtherComplicationCategory).WithMany(p => p.IvfepisodeTransferFurtherComplicationCategory).HasConstraintName("FK_IVFEpisodeTransfer_DropdownConfiguration2");

            entity.HasOne(d => d.MainCompilationCategory).WithMany(p => p.IvfepisodeTransferMainCompilationCategory).HasConstraintName("FK_IVFEpisodeTransfer_DropdownConfiguration1");

            entity.HasOne(d => d.Nurse).WithMany(p => p.IvfepisodeTransferNurse).HasConstraintName("FK_IVFEpisodeTransfer_HREmployee1");

            entity.HasOne(d => d.Provider).WithMany(p => p.IvfepisodeTransferProvider).HasConstraintName("FK_IVFEpisodeTransfer_HREmployee");

            entity.HasOne(d => d.Transfer).WithOne(p => p.IvfepisodeTransfer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFEpisodeTransfer_IVFTreatmentEpisodeTransferStage");
        });

        modelBuilder.Entity<IvfepisodeTransferEmbryoInTransfer>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.ScoreCategory).WithMany(p => p.IvfepisodeTransferEmbryoInTransfer).HasConstraintName("FK_IVFEpisodeTransferEmbryoInTransfer_DropdownConfiguration");

            entity.HasOne(d => d.Transfer).WithMany(p => p.IvfepisodeTransferEmbryoInTransfer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFEpisodeTransferEmbryoInTransfer_IVFTreatmentEpisodeTransferStage");
        });
        ...
        modelBuilder.Entity<IvffemaleFertilityHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.ChromosomeAnalysisCategory).WithMany(p => p.IvffemaleFertilityHistoryChromosomeAnalysisCategory).HasConstraintName("FK_IVFFemaleFertilityHistory_DropdownConfiguration2");
            ...
            entity.HasOne(d => d.Ivfmain).WithMany(p => p.IvffemaleFertilityHistory)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFFemaleFertilityHistory_IVFMain");
        ...
        modelBuilder.Entity<IvflabOrderSet>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");
            ...
            entity.HasOne(d => d.Overview).WithMany(p => p.IvflabOrderSet)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFLabOrderSet_IVFTreatmentEpisodeOverviewStage");
        });
        ...
        modelBuilder.Entity<IvfmaleCryoContracts>(entity =>
        {
            entity.HasKey(e => e.CryoContractId).HasName("PK__IVFMaleC__F73C263B85575133");
        ...
        modelBuilder.Entity<IvfmaleCryoPreservation>(entity =>
        {
            entity.HasKey(e => e.CryoPreservationId).HasName("PK__IVFMaleC__5027C62D65A8D4B9");

            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysutcdatetime())");
            entity.Property(e => e.IsDeleted).HasDefaultValue(false);
            entity.Property(e => e.PreserveUsingCryoStorage).HasDefaultValue(true);
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysutcdatetime())");

            entity.HasOne(d => d.Color).WithMany(p => p.IvfmaleCryoPreservation).HasConstraintName("FK_IVFMaleCryoPreservation_Color");

            entity.HasOne(d => d.CryoContract).WithMany(p => p.IvfmaleCryoPreservation).HasConstraintName("FK_IVFMaleCryoPreservation_CryoContract");

            entity.HasOne(d => d.MaterialType).WithMany(p => p.IvfmaleCryoPreservationMaterialType).HasConstraintName("FK_IVFMaleCryoPreservation_MaterialType");

            entity.HasOne(d => d.OriginallyFromClinic).WithMany(p => p.IvfmaleCryoPreservationOriginallyFromClinic).HasConstraintName("FK_IVFMaleCryoPreservation_OriginallyFromClinic");

            entity.HasOne(d => d.ReasonForResearch).WithMany(p => p.IvfmaleCryoPreservationReasonForResearch).HasConstraintName("FK_IVFMaleCryoPreservation_ReasonForResearch");

            entity.HasOne(d => d.Sample).WithMany(p => p.IvfmaleCryoPreservation)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFMaleCryoPreservation_sampleContract");

            entity.HasOne(d => d.Status).WithMany(p => p.IvfmaleCryoPreservationStatus).HasConstraintName("FK_IVFMaleCryoPreservation_Status");

            entity.HasOne(d => d.StoragePlace).WithMany(p => p.IvfmaleCryoPreservation).HasConstraintName("FK_IVFMaleCryoPreservation_CryoLevelC");
        });

        modelBuilder.Entity<IvfmaleCryoStraw>(entity =>
        {
            entity.HasKey(e => e.CryoStrawId).HasName("PK__IVFMaleC__02711F604B15B3D3");

            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysutcdatetime())");
            entity.Property(e => e.IsDeleted).HasDefaultValue(false);
            entity.Property(e => e.Status).HasDefaultValue("Stored");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysutcdatetime())");

            entity.HasOne(d => d.Color).WithMany(p => p.IvfmaleCryoStraw).HasConstraintName("FK_IVFMaleCryoPreservation_Colorstraw");

            entity.HasOne(d => d.CryoPreservation).WithMany(p => p.IvfmaleCryoStraw)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFMaleCryoPreservation_cryopreservation");

            entity.HasOne(d => d.MaterialType).WithMany(p => p.IvfmaleCryoStraw).HasConstraintName("FK_IVFMaleCryoPreservation_materialtypestarw");

            entity.HasOne(d => d.Sample).WithMany(p => p.IvfmaleCryoStraw)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFMaleCryoPreservation_sampleContractsraw");

            entity.HasOne(d => d.StorageLevelC).WithMany(p => p.IvfmaleCryoStraw).HasConstraintName("FK_IVFMaleCryoPreservation_CryoLevelCstaw");
        });
        ...
        modelBuilder.Entity<IvfmaleFertilityHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.Provider).WithMany(p => p.IvfmaleFertilityHistory).HasConstraintName("FK_IVFMaleFH_Provider");
        });
        ...
        modelBuilder.Entity<IvfmaleFhimpairmentFactor>(entity =>
        {
            ...
            entity.HasOne(d => d.ImpairmentFactorNavigation).WithMany(p => p.IvfmaleFhimpairmentFactor)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFMaleFHImpairmentFactor_BLMasterICD9CM");
        ...
        modelBuilder.Entity<IvfmaleFhinfections>(entity =>
        {
            ...
            entity.HasOne(d => d.CategoryIdDiagnosisOfInfectionNavigation).WithMany(p => p.IvfmaleFhinfectionsCategoryIdDiagnosisOfInfectionNavigation).HasConstraintName("FK_IVFMaleFHInfections_DropdownConfiguration1");

            entity.HasOne(d => d.CategoryIdPrevInfectionsNavigation).WithMany(p => p.IvfmaleFhinfectionsCategoryIdPrevInfectionsNavigation).HasConstraintName("FK_IVFMaleFHInfections_DropdownConfiguration");
        ...
        modelBuilder.Entity<IvfmaleFhprevIllness>(entity =>
        {
            ...
            entity.HasOne(d => d.PrevIllnessNavigation).WithMany(p => p.IvfmaleFhprevIllness)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFMaleFHPrevIllness_BLMasterICD9CM");
        });
        ...
        modelBuilder.Entity<IvfmaleSemenSample>(entity =>
        {
            ...
            entity.HasOne(d => d.CryoStatus).WithMany(p => p.IvfmaleSemenSampleCryoStatus).HasConstraintName("FK_IVFMaleCryoPreservation_semansamplcryoestatus");
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.IvfmaleSemenSampleStatus).HasConstraintName("FK_IVFMaleCryoPreservation_semansamplestatus");
        ...
        modelBuilder.Entity<IvfoverviewMedicationApplicationDomain>(entity =>
        {
            entity.HasKey(e => e.IvfmedicationDropDownId).HasName("PK_IVFMedicationDropDown");

            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.Category).WithMany(p => p.IvfoverviewMedicationApplicationDomain)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFMedicationDropDown_DropdownConfiguration");

            entity.HasOne(d => d.Medication).WithMany(p => p.IvfoverviewMedicationApplicationDomain)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFMedicationDropDown_Medications");
        });

        modelBuilder.Entity<IvfoverviewMedicationTime>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.Medication).WithMany(p => p.IvfoverviewMedicationTime)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFOverviewMedicationTime_Medications");
        });
        ...
        modelBuilder.Entity<IvfoverviewOhss>(entity =>
        {
            ...
            entity.HasOne(d => d.AdverseSideEffectsCategory).WithMany(p => p.IvfoverviewOhssAdverseSideEffectsCategory).HasConstraintName("FK_IVFOverviewOHSS_DropdownConfiguration1");

            entity.HasOne(d => d.OhssdiagnosisCategory).WithMany(p => p.IvfoverviewOhssOhssdiagnosisCategory).HasConstraintName("FK_IVFOverviewOHSS_DropdownConfiguration");

            entity.HasOne(d => d.Overview).WithMany(p => p.IvfoverviewOhss).HasConstraintName("FK_IVFOverviewOHSS_IVFTreatmentEpisodeOverviewStage");
        });
        ...
        modelBuilder.Entity<IvfperformedAdditionalMeasures>(entity =>
        {
            ...
            entity.HasOne(d => d.IvfadditionalMeasures).WithMany(p => p.IvfperformedAdditionalMeasures).HasConstraintName("FK_IVFFemaleFHPerformedAdditionalMeasures_IVFFemaleFHAdditionalMeasures");

            entity.HasOne(d => d.PerformedAdditionalMeasuresCategory).WithMany(p => p.IvfperformedAdditionalMeasures).HasConstraintName("FK_IVFFemaleFHPerformedAdditionalMeasures_DropdownConfiguration");
        });

        modelBuilder.Entity<IvfplannedAdditionalMeasures>(entity =>
        {
        ...
        modelBuilder.Entity<IvfpolarBodiesIndications>(entity =>
        {
        ...
        modelBuilder.Entity<IvfpregnancyComplicationAfter20th>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.Pregnancy).WithMany(p => p.IvfpregnancyComplicationAfter20th)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFPregnancyComplicationAfter20th_IVFTreatmentEpisodePregnancyStage");
        });

        modelBuilder.Entity<IvfpregnancyComplicationUntil20th>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.Pregnancy).WithMany(p => p.IvfpregnancyComplicationUntil20th)
                .HasPrincipalKey(p => p.PregnancyId)
                .HasForeignKey(d => d.PregnancyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFPregnancyComplicationUntil20th_IVFEpisodePregnancy");
        });
        ...
        modelBuilder.Entity<IvfprescriptionMaster>(entity =>
        {
            ...
            entity.HasOne(d => d.Medication).WithMany(p => p.IvfprescriptionMaster)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFPrescriptionMaster_Medications");
        ...
        {
            entity.HasKey(e => e.ColorId).HasName("PK__IVFStraw__8DA7674DA3E4BF8B");
        ...
        modelBuilder.Entity<IvftreatmentEpisodePregnancyStage>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.IvfdashboardTreatmentCycle).WithOne(p => p.IvftreatmentEpisodePregnancyStage)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFTreatmentEpisodePregnancyStage_IVFDashboardTreatmentCycle");
        });

        modelBuilder.Entity<IvftreatmentEpisodeTransferStage>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(sysdatetime())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(sysdatetime())");

            entity.HasOne(d => d.IvfdashboardTreatmentCycle).WithOne(p => p.IvftreatmentEpisodeTransferStage)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IVFTreatmentEpisodeTransferStage_IVFDashboardTreatmentCycle");
        });
        ...
        modelBuilder.Entity<IvftreatmentPlannedSpermCollection>(entity =>
        {
            ...
            entity.HasOne(d => d.IvfdashboardTreatmentCycle).WithMany(p => p.IvftreatmentPlannedSpermCollection).HasConstraintName("FK_IVFTreatmentPlannedSpermCollection_IVFTreatmentPlannedSpermCollection");

            entity.HasOne(d => d.PlannedSpermCollectionCategory).WithMany(p => p.IvftreatmentPlannedSpermCollection).HasConstraintName("FK_IVFTreatmentPlannedSpermCollection_DropdownConfiguration");
        });
        ...
        {
            entity.HasKey(e => e.MedicationId).HasName("PK_Prescription");

            entity.HasIndex(e => e.ProviderId, "IX_Prescription_ProviderId").HasFilter("([ProviderId] IS NOT NULL)");

            entity.HasOne(d => d.Appointment).WithMany(p => p.Medications).HasConstraintName("fk_appointment");

            entity.HasOne(d => d.Drug).WithMany(p => p.Medications).HasConstraintName("FK_Prescription_TabsDrugName_DrugId");

            entity.HasOne(d => d.Provider).WithMany(p => p.Medications).HasConstraintName("fk_provider");
        });
        ...
        {
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.RegCompany).HasConstraintName("FK_RegCompany_HREmployee");
        });
