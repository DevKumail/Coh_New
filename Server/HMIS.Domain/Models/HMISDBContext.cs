...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=AMEEN;Initial Catalog=HMISDB;user id=sa;password=123qwe;integrated security=True;Trusted_Connection=True;Encrypt=Yes;TrustServerCertificate=Yes");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(e => e.AlergyTypeId).ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<Blpayer>(entity =>
            {
                entity.HasKey(e => e.PayerId)
                    .HasName("PK__BLPayer__0ADBE86729090DBE");
            ...
            modelBuilder.Entity<PatientAllergy>(entity =>
            {
                ...
                entity.HasOne(d => d.Appointment)
                    ...
                    .HasForeignKey(d => d.AppointmentId)
                    .HasConstraintName("FK_PatientAllergy_SchAppointment");
            });
            ...
            modelBuilder.Entity<PatientProblem>(entity =>
            {
                entity.HasOne(d => d.Appointment)
                    ...
                    .HasForeignKey(d => d.AppointmentId)
                    .HasConstraintName("FK_PatientProblem_AppointmentId");

                entity.HasOne(d => d.CreatedByNavigation)
                    .WithMany(p => p.PatientProblemCreatedByNavigations)
                    .HasForeignKey(d => d.CreatedBy)
                    .HasConstraintName("FK_PatientProblem_CreatedBy");

                entity.HasOne(d => d.Patient)
                    .WithMany(p => p.PatientProblems)
                    .HasForeignKey(d => d.PatientId)
                    .HasConstraintName("FK_PatientProblem_PatientId");

                entity.HasOne(d => d.UpdatedByNavigation)
                    .WithMany(p => p.PatientProblemUpdatedByNavigations)
                    .HasForeignKey(d => d.UpdatedBy)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PatientProblem_UpdatedBy");
            });
            ...
            {
                entity.HasKey(e => e.GenderId)
                    .HasName("PK__RegGende__4E24E9F779BB10BB");
