...
{
    [Table("BLMasterProcedures")]
    public partial class BlmasterProcedure
    {
        public BlmasterProcedure()
        {
        ...
        [InverseProperty("BlmasterProcedureCreatedByNavigations")]
        public virtual Hremployee CreatedByNavigation { get; set; }
        [ForeignKey("ProcedureTypeId")]
        [InverseProperty("BlmasterProcedures")]
        public virtual ProcedureType ProcedureType { get; set; }
        [ForeignKey("UpdatedBy")]
        [InverseProperty("BlmasterProcedureUpdatedByNavigations")]
