...
namespace HMIS.Data.Models
{
    ...
    {
        public SchAppointment()
        {
            BleligibilityLogs = new HashSet<BleligibilityLog>();
            BlpatientVisits = new HashSet<BlpatientVisit>();
            BlsuperBillDiagnoses = new HashSet<BlsuperBillDiagnosis>();
            BlsuperBillProcedureInvoices = new HashSet<BlsuperBillProcedureInvoice>();
            BlsuperBillProcedures = new HashSet<BlsuperBillProcedure>();
            ...
            PatientBillInvoices = new HashSet<PatientBillInvoice>();
        ...
        [InverseProperty("SchAppointments")]
        public virtual SchAppointmentStatus AppStatus { get; set; }
        ...
        [InverseProperty("SchAppointments")]
        public virtual SchPatientStatus PatientStatus { get; set; }
        [ForeignKey("PayerId")]
        [InverseProperty("SchAppointments")]
        ...
        [ForeignKey("SiteId")]
        [InverseProperty("SchAppointments")]
        public virtual RegLocationType Site { get; set; }
        ...
        public virtual ICollection<BleligibilityLog> BleligibilityLogs { get; set; }
        [InverseProperty("Appointment")]
        ...
        public virtual ICollection<BlsuperBillProcedureInvoice> BlsuperBillProcedureInvoices { get; set; }
        [InverseProperty("Appointment")]
        public virtual ICollection<BlsuperBillProcedure> BlsuperBillProcedures { get; set; }
        ...
        [InverseProperty("Appointment")]
        public virtual ICollection<PatientBillInvoice> PatientBillInvoices { get; set; }
        [InverseProperty("Appointment")]
