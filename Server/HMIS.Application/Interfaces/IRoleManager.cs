...
namespace HMIS.Service.Implementations
{
    ...
    {
        Task<bool> InsertRoleDB(HMIS.Service.DTOs.ControlPanel.SecRole secrole);
        ...
        Task<bool> UpdateRoleDB(HMIS.Service.DTOs.ControlPanel.SecRole secrole);
        ...
        Task<bool> AssignRoles(HMIS.Service.DTOs.ControlPanel.RolesDto role);
    }
}
