...
namespace HMIS.Service.ServiceLogics
{
    public class ProviderScheduleManager : IProviderScheduleManager
    {
        ...
        public ProviderScheduleManager(HIMSDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<bool> InsertProviderScheduleDB(DTOs.ProviderSchedule ps)
        {
            try
            {
                ...
                Data.Models.ProviderSchedule providerSchedule = new Data.Models.ProviderSchedule()
                {
                ...
                if (ps.providerScheduleByAppType != null && ps.providerScheduleByAppType.Count > 0)
                {
                    ...
                    {
                        Data.Models.ProviderScheduleByAppType psa = new Data.Models.ProviderScheduleByAppType()
                        {
                            IsDeleted = false,
