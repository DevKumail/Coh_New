...
using SchAppointment = HMIS.Service.DTOs.AppointmentDTOs.SchAppointmentModel;
...
namespace HMIS.Service.ServiceLogics
{
    public class AppointmentManager : IAppointmentManager
    {
        ...
        public AppointmentManager(HIMSDBContext context, IUnitOfWork unitOfWork)
        {
            _context = context;
        ...
        public async Task<bool> InsertAppointmentDB(SchAppointment schApp)
        {
            using (var transaction = _unitOfWork.BeginTransaction())
            {
                ...
                try
                {
                    ...
                    Data.Models.SchAppointment schAppointment = new Data.Models.SchAppointment();
                    ...
                    //Data.Models.BlpatientVisit blpatientVisit = new BlpatientVisit()
                    //{
                    ...
                    //Data.Models.PatientVisitStatus patientVisitStatus = new PatientVisitStatus()
                    //{
        ...
        //                //    IsDeleted = false,
        //                //};
        //                Data.Models.PatientVisitStatus patientVisitStatus = new Data.Models.PatientVisitStatus();
        ...
        public async Task<bool> InsertSpeech(SpeechModel sp)
        {
            ...
            try
            {
                ...
                Data.Models.SpeechToText speech = new Data.Models.SpeechToText()
                {
 ...
 public async Task<SchAppointment> GetAppoimentForEditById ( long appId)
        {
            try
            {
                ...
                IQueryable<Data.Models.SchAppointment> appointment1 = (IQueryable<Data.Models.SchAppointment>)_context.SchAppointments.Where(x => x.AppId == appId);

                Data.Models.SchAppointment result = appointment1.FirstOrDefault();





                //IQueryable<Data.Models.SchAppointment> appointment1 = (IQueryable<Data.Models.SchAppointment>)await Task.Run(() => 
                ...
                //var result = (Data.Models.SchAppointment)appointment1;
