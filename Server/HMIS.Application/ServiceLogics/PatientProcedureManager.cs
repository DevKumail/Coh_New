...
namespace HMIS.Service.ServiceLogics
{
    public class PatientProcedureManager : IPatientProcedure
    {
        ...
        public PatientProcedureManager(HIMSDBContext context, IConfiguration configuration)
        {
            _context = context;
            ...
            try
            {
                ...
                if (!exist)
                {
                   ...
                   newPatientProc.UpdatedBy = patientProcedure.UpdatedBy;
                    ...
                    newPatientProc.PerformedOnFacility = patientProcedure.PerformedOnFacility;
                    ...
                    if (patient != null)
                    {
                     ...
                     //   patient.CreatedBy = patientProcedure.CreatedBy;
                       // patient.CreatedDate = patientProcedure.CreatedDate;
                        ...
                        patient.PerformedOnFacility = patientProcedure.PerformedOnFacility;
