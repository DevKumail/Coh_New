...
namespace HMIS.Service.ServiceLogics
{
    public class DemographicManager : IDemographicManager
    {
        ...
        public DemographicManager(HIMSDBContext context)
        {
            _context = context;
        }
...

            {
                ...
                if (findResult != null)
                {
                    ...
                    foreach (var item in regUpdate.regPatientEmployer)
                    {
                        ...
                        Data.Models.RegPatientEmployer regPatientEmployer = new Data.Models.RegPatientEmployer()
                        {
                    ...
                    {
                        Data.Models.RegAccount regAccount = new Data.Models.RegAccount()
                        {
                            Mrno = findResult.Mrno,
                            TypeId = item1.TypeId,
                    ...
                    //{
                    Data.Models.RegPatientDetail contact = new Data.Models.RegPatientDetail()
                    {
                    ...
                    Data.Models.RegPatientDetail employment = new Data.Models.RegPatientDetail()
                    {
                    ...
                    Data.Models.RegPatientDetail emergencycontact = new Data.Models.RegPatientDetail()
                    {
                    ...
                    Data.Models.RegPatientDetail nextOfKin = new Data.Models.RegPatientDetail()
                    {
                    ...
                    Data.Models.RegPatientDetail spouse = new Data.Models.RegPatientDetail()
                    {
                    ...
                    Data.Models.RegPatientDetail parent = new Data.Models.RegPatientDetail()
                    {
                    ...
                    Data.Models.RegPatientDetail assigment = new Data.Models.RegPatientDetail()
                    {
                    ...
                    Data.Models.RegPatientDetail familyMember = new Data.Models.RegPatientDetail()
                    {
        ...
        public async Task<bool> InsertDemographicDB(RegInsert regInsert)
        {
            ...
            //{
            //    Data.Models.RegPatientDetail regPatientDetail = new Data.Models.RegPatientDetail()
            //    {
            ...
            //}
            ////Data.Models.em regPatientDetail = new Data.Models.RegPatientDetail()
