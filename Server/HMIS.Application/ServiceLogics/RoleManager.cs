...
namespace HMIS.Service.ServiceLogics
{
    public class RoleManager : IRoleManager
    {
        ...
        public RoleManager( HIMSDBContext context)
        {
            _context = context;

        }

        public async Task<bool> InsertRoleDB(HMIS.Service.DTOs.ControlPanel.SecRole secrole)
        {
            try

            {
                ...
                HMIS.Service.DTOs.ControlPanel.SecRole role = new HMIS.Service.DTOs.ControlPanel.SecRole();
        ...
        public async Task<bool> AssignRoles(HMIS.Service.DTOs.ControlPanel.RolesDto role)
        {
            try
            {
                ...
                HMIS.Service.DTOs.ControlPanel.RolesDto roleDto = new HMIS.Service.DTOs.ControlPanel.RolesDto();
                ...
                foreach (int formId in uniqueFormIds)
                {
                    ...
                    {
                        HMIS.Data.Models.SecRoleForm secRole = new Data.Models.SecRoleForm();
                ...
                foreach (var item in role.AssignedRoleList)
                {
                    ...
                    HMIS.Data.Models.SecPrivilegesAssignedRole assignRole = new Data.Models.SecPrivilegesAssignedRole();
        ...
        public async Task<bool> UpdateRoleDB(HMIS.Service.DTOs.ControlPanel.SecRole secrole)
        {
            ...
            try
            {
                Data.Models.Hremployee EMP = new Data.Models.Hremployee();
