...
namespace HMIS.Web.Controllers.ControllerPanel
{
    ...
    .Build();
        ...
        public async Task<IActionResult> InsertProviderSchedule(Application.DTOs.ProviderSchedule PS)
        {
            var method = HttpContext.Request.Method;
            var path = HttpContext.Request.Path;
            var configuration = new ConfigurationBuilder()
    ...
    method, path, statusCode, elapsed, requestMessage, responseMessage);
        ...
        [HttpGet("DeleteProviderSchedule")]
    ...
    .Build();
        ...
        [HttpGet("GetDurationOfTimeSlot")]
        public async Task<IActionResult> GetDurationOfTimeSlot(int SiteId, int ProviderId, int FacilityId, string Days)
        {

            var result = await _providerSceduleManager.GetDurationOfTimeSlot(SiteId, ProviderId, FacilityId, Days);
            if (result != null)
            {
                return Ok(result);
            }
