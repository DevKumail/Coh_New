...
namespace HMIS.API.Controllers.ControllerPanel
{
    ...
    public class RoleController : BaseApiController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> InsertRoles(HMIS.Service.DTOs.ControlPanel.SecRole secrole)
        {
        ...
        public async Task<IActionResult> UpdateRole(HMIS.Service.DTOs.ControlPanel.SecRole secrole)
        {
        ...
        public async Task<IActionResult> AssignRoleAndModules(HMIS.Service.DTOs.ControlPanel.RolesDto role)
        {
